    ...
    <div className="min-h-screen bg-[#FDFAF5] text-[#2A2623] flex items-center justify-center px-6 font-sans overflow-hidden selection:bg-[#2A2623] selection:text-white">
      <div className="text-center space-y-16 max-w-4xl relative">
        ...
        >
          <Link 
            to="/" 
            className="group relative inline-flex items-center gap-6 px-14 py-5 bg-[#2A2623] text-white text-[11px] tracking-[0.3em] font-bold uppercase transition-all duration-500 rounded-full overflow-hidden shadow-2xl hover:shadow-[#2A2623]/20 active:scale-95"
          >
          ...
          <Link 
            to="/shop" 
            className="group inline-flex items-center gap-6 px-14 py-5 border border-[#2A2623]/20 text-[#2A2623] text-[11px] tracking-[0.3em] font-bold uppercase hover:bg-[#2A2623] hover:text-white transition-all duration-500 rounded-full active:scale-95"
          >
            <Search size={16} />
            Browse Collection
          </Link>
        ...
        <motion.div
          ...
          className="pt-24"
        >
          <p className="text-[10px] tracking-[0.2em] text-[#2A2623]/30 uppercase">
