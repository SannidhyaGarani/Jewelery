    ...
    <div className="min-h-screen bg-[#FDFAF5] pt-48 pb-32 font-sans relative overflow-hidden text-[#2C1A0E]">
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16 relative z-10">
        <div className="editorial-grid gap-24">
          ...
          <div className="col-span-12 lg:col-span-5 space-y-16">
            <div className="space-y-10">
              <motion.span 
                ...
                className="block text-[10px] tracking-[0.6em] uppercase text-[#5C3D1E]/60 font-bold"
              >
                At Your Service
              </motion.span>
              <motion.h1 
                ...
                className="text-4xl md:text-5xl lg:text-7xl font-serif text-[#2C1A0E] leading-[1.1] tracking-tight"
              >
                <span style={{fontFamily: "var(--font-script)", fontWeight: 100}} className="text-5xl md:text-7xl lg:text-8xl text-[#640D14]/80">Inquire</span> <br />
                Privately
              </motion.h1>
              <motion.p 
                initial={{ opacity: 0 }}
                ...
                className="text-sm text-[#5C3D1E]/70 font-light tracking-wide leading-relaxed max-w-md"
              >
            ...
            <div className="space-y-12 border-t border-[#640D14]/10 pt-12">
              {[
                ...
                >
                  <div className="text-[#640D14] mt-1">{item.icon}</div>
                  <div>
                    <p className="text-[9px] tracking-[0.4em] uppercase text-[#5C3D1E]/40 mb-2 font-bold">{item.label}</p>
                    <p className="text-xl font-serif text-[#2C1A0E] transition-colors group-hover:text-[#640D14] cursor-default">{item.val}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="flex gap-10 pt-8">
               {['Instagram', 'LinkedIn', 'Pinterest'].map((social, i) => (
                 <a key={i} href="#" className="text-[10px] tracking-[0.3em] uppercase text-[#5C3D1E]/40 hover:text-[#640D14] transition-colors font-bold">
                   {social}
                 </a>
               ))}
            </div>
          ...
          >
            <div className="bg-[#F5EDD8]/20 backdrop-blur-xl p-10 md:p-20 border border-[#640D14]/10 luxury-card rounded-[32px] shadow-sm">
              <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
                <div className="grid md:grid-cols-2 gap-12">
                  <div className="space-y-4">
                    <label className="text-[9px] tracking-[0.4em] uppercase text-[#5C3D1E]/40 font-bold">Full Name</label>
                    <input type="text" className="w-full bg-transparent border-b border-[#640D14]/10 py-4 font-serif text-lg text-[#2C1A0E] outline-none focus:border-[#640D14] transition-all placeholder:text-[#5C3D1E]/20" placeholder="your name" />
                  </div>
                  <div className="space-y-4">
                    <label className="text-[9px] tracking-[0.4em] uppercase text-[#5C3D1E]/40 font-bold">Email</label>
                    <input type="email" className="w-full bg-transparent border-b border-[#640D14]/10 py-4 font-serif text-lg text-[#2C1A0E] outline-none focus:border-[#640D14] transition-all placeholder:text-[#5C3D1E]/20" placeholder="email address" />
                  </div>
                </div>
                
                <div className="space-y-4">
                   <label className="text-[9px] tracking-[0.4em] uppercase text-[#5C3D1E]/40 font-bold">Inquiry Nature</label>
                   <div className="relative">
                      <select className="w-full bg-transparent border-b border-[#640D14]/10 py-4 text-lg text-[#2C1A0E] outline-none focus:border-[#640D14] transition-all appearance-none cursor-pointer font-serif">
                         <option className="bg-[#FDFAF5]">Bespoke Commission</option>
                         <option className="bg-[#FDFAF5]">Private Showroom Appointment</option>
                         <option className="bg-[#FDFAF5]">Collection Enquiries</option>
