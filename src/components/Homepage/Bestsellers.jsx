...
const BestSellers = () => {
  ...
  return (
    <section 
      className="bg-[#FCFCFC] py-16 lg:py-24 relative overflow-hidden"
    ...
    >
      ...
      <div className="max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="relative">
          ...
          >
            {products.map((product) => (
              <SwiperSlide key={product.id}>
                ...
                >
                  {/* Image Container */}
                  <div className="relative aspect-[4/5] bg-white overflow-hidden rounded-sm transition-all duration-700 ease-out group-hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]">
                    <motion.img
                    ...
                    <div className="absolute bottom-6 left-6 right-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                      <button className="w-full bg-white/90 backdrop-blur-md py-4 text-[10px] tracking-[0.2em] font-bold uppercase text-neutral-900 flex items-center justify-center gap-2">
          ...
          <div className="mt-20 h-[1px] w-full bg-neutral-100 relative">
             <motion.div 
               className="absolute top-0 left-0 h-full bg-neutral-900 w-1/4"
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 opacity-[0.02] pointer-events-none">
        <span className="text-[300px] font-serif italic">V</span>
      </div>
    </section>
  );
};
