          ...
          <div className="w-full lg:w-[50%] relative group">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 bg-white/80 backdrop-blur-2xl border border-[#640D14]/20 p-6 md:p-8 rounded-[20px] md:rounded-3xl text-[#2C1A0E] shadow-lg">
                <p className="text-[8px] md:text-[10px] tracking-[0.4em] uppercase font-bold text-[#640D14] mb-2">Heritage Promise</p>
          ...
          <div className="w-full lg:w-[50%] space-y-12 md:space-y-16">
            <div className="space-y-6 text-left">
              <motion.span
                ...
                viewport={{ once: true }}
                className="text-[9px] md:text-[10px] tracking-[0.5em] uppercase font-bold text-[#640D14]"
              >
                Atelier Privé
              </motion.span>
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[11px] tracking-[0.15em] uppercase font-medium text-[#5C3D1E]/60 leading-relaxed group-hover:text-[#5C3D1E] transition-colors">
                      {service.description}
                    </p>
                  </div>
                </motion.div>
