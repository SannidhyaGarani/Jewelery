        ...
        <div className="relative h-full flex flex-col justify-center px-8 md:px-16 lg:px-24 max-w-4xl space-y-8 md:space-y-10">
          ...
          >
            {['JOURNAL', 'CRAFTSMANSHIP'].map(tag => (
              <span key={tag} className="bg-[#640D14]/10 backdrop-blur-md border border-[#640D14]/20 px-4 md:px-5 py-2 rounded-full text-[9px] md:text-[10px] tracking-[0.3em] font-black text-[#640D14] uppercase">
                {tag}
              </span>
            ))}
          </motion.div>
          ...
          <motion.div 
            ...
            className="text-[#640D14]/60 text-[10px] md:text-[11px] tracking-[0.4em] font-black uppercase pt-6 flex items-center gap-6"
          >
          ...
          <motion.div
            ...
            className="pt-4"
          >
            <button className="px-10 py-4 bg-[#640D14] text-[#FDFAF5] text-[10px] tracking-[0.3em] font-black uppercase rounded-full hover:bg-[#2C1A0E] transition-colors duration-500 shadow-xl shadow-[#640D14]/20">
              Read the Story
            </button>
          </motion.div>
