...
const EditorialBanner = () => {
  return (
    <section className="px-4 lg:px-10 py-12">
      <div className="relative w-full h-[600px] lg:h-[700px] rounded-[32px] overflow-hidden group">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-neutral-900/40" /> {/* Darker overlay for readability */}
        </div>

        {/* Content Overlay */}
        <div className="relative h-full flex flex-col justify-center px-8 lg:px-24 max-w-4xl space-y-8">
          <motion.div 
          ...
          >
            {['JEWELLERY', 'PROFILE'].map(tag => (
              <span key={tag} className="bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-full text-[9px] tracking-[0.2em] font-bold text-white uppercase">
                {tag}
              </span>
            ))}
          </motion.div>
          ...
          <div className="space-y-4">
            ...
            >
              <span 
                ...
                className="text-6xl md:text-7xl lg:text-8xl block mb-4"
              >
                From Mine, to Klein,
              </span>
            ...
            <motion.p 
              ...
              className="text-white/70 text-sm md:text-base font-sans leading-relaxed max-w-xl"
            >
