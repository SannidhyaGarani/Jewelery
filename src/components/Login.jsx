  ...
  return (
    <div className="min-h-screen bg-[#F8F4EF] flex items-center justify-center px-4 py-20 relative overflow-hidden selection:bg-[#7A0E2E] selection:text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#7A0E2E]/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#7A0E2E]/3 rounded-full blur-[120px]" />
      </div>
      ...
      <motion.div 
        ...
        className="w-full max-w-[460px] bg-white/40 backdrop-blur-xl rounded-[48px] border border-[#D8CBBE]/30 shadow-[0_32px_80px_rgba(122,14,46,0.08)] p-10 md:p-16 relative z-10"
      >
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-[#2A2623] tracking-tighter leading-none mb-4 font-bold">
            The <span className="text-[#7A0E2E] italic font-light">Atelier</span>
          </h2>
          <p className="text-[#7B6D63] font-serif text-lg italic">Welcome back to Velouraz</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="space-y-3">
            <label className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#7B6D63] ml-2">Email Credentials</label>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center px-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#7B6D63]">Secret Password</label>
              <button type="button" className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#7A0E2E]/60 hover:text-[#2A2623] transition-colors">Recover</button>
            </div>
            <div className="relative group">
          ...
          <button
            type="submit"
            disabled={loading}
            className="group w-full py-5 rounded-[24px] bg-[#2A2623] text-white font-bold text-[11px] tracking-[0.4em] uppercase hover:bg-[#7A0E2E] transition-all transform active:scale-[0.98] shadow-2xl shadow-[#2A2623]/10 flex items-center justify-center gap-4 mt-6"
          >
            {loading ? (
        ...
        <div className="mt-12 pt-10 border-t border-[#D8CBBE]/30 text-center">
          <p className="text-[10px] text-[#7B6D63] font-bold tracking-widest uppercase">
            New to the legacy?{" "}
            <Link to="/signup" className="text-[#7A0E2E] font-black hover:text-[#2A2623] ml-2 transition-colors border-b-2 border-[#7A0E2E]/20 hover:border-[#2A2623] pb-1">
              Apply Here
            </Link>
          </p>
        </div>
